...
$sql="select * from price where name like '%$name%'"; //RAS-POS 1.5ver부터 부분한글검색이 가능하게 되었다.
...
?></span></font></p>
        ...
        <td width="416" height="27">                                                <p style="line-height:200%;" align="center">
<font face="HY울릉도B"><span style="font-size:24pt;"><?php
$name = $_POST['name']; 
...
$sql="select * from price where name like '%$name%'"; 
